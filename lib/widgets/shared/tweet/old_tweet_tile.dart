...
class OldTweetTile extends StatefulWidget {
  final Tweet tweet;
  ...
  @override
  OldTweetTileState createState() => OldTweetTileState();
}

class OldTweetTileState extends State<OldTweetTile> {
  ...
  Widget _buildMedia() {
    return tweet.extended_entities?.media != null
        ? OldCollapsibleMedia(tweet: widget.tweet)
        : Container();
  }
